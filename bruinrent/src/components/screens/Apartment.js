    ...
    useEffect(() => {
        ...
        const fetchDataFromFirebase = async () => {
            ...
            try {
                ...
                const listingDocRef = doc(firestore, "listings", id);
                const listingDocSnapshot = await getDoc(listingDocRef);

                // Fetch data from 'test_csv' collection
                const testCsvDocRef = doc(firestore, "test_csv", id);
                const testCsvDocSnapshot = await getDoc(testCsvDocRef);
                ...
                if (listingDocSnapshot.exists()) {
                    combinedData = {
                        ...combinedData,
                        ...listingDocSnapshot.data(),
                    };
                }

                if (testCsvDocSnapshot.exists()) {
                    combinedData = {
                        ...combinedData,
                        ...testCsvDocSnapshot.data(),
                    };
                }

                // Update apartmentData state with combined data
                setApartmentData(combinedData);
    ...
    useEffect(() => {
        const fetchData = async () => {
            if (apartmentData.reviews && apartmentData.reviews.length > 0) {
                console.log(
                    "reviewData: " + JSON.stringify(apartmentData.reviews)
                );
                let r_count = 0;
                let r_value = [];
                let r_land = [];
                ...
                const fetchReviewData = async (reviewID) => {
                    try {
                        ...
                        if (docSnapshot.exists()) {
                            const data = docSnapshot.data();
                            console.log(
                                "RAW Review data: " + JSON.stringify(data)
                            );
                            const reviewToAdd = {
                            ...
                            console.log(
                                "Review to add: " + JSON.stringify(reviewToAdd)
                            );
                ...
                try {
                    ...
                    setReviewStats({
                        ...
                        Cleanliness: parseFloat(
                            finalScoreCleanliness.toFixed(1)
                        ),
                    });
                } catch (error) {
            ...
            <div className="apartment-homepage-container">
                ...
                <div className="apartment-homepage-header">
                    ...
                    <div className="header-subtext">
                        ...
                        >
                            {" "}
                            {apartmentData.bedrooms} bed | {apartmentData.baths}{" "}
                            bath | {apartmentData.size} sqft
                        </span>
                    </div>
                </div>
                                ...
                                <div className="info-block">
                                    ...
                                    <BoxTemplate>
                                        <div className="content-container">
                                            <h2>
                                                Parking type:{" "}
                                                {apartmentData.parkingType}
                                            </h2>
                                            <ul className="main-features-list">
                                                <li>
                                                    Single Price:{" "}
                                                    {
                                                        apartmentData.parkingSinglePrice
                                                    }
                                                </li>
                                                <li>
                                                    Tandem Price:{" "}
                                                    {
                                                        apartmentData.parkingTandemPrice
                                                    }
                                                </li>
                                            </ul>
                                        </div>
            ...
            <div className="info-block">
              <h1>Transportation</h1> */}
                ...
                <h2>Value</h2>
                            ...
                            <div className="rating-block">
                                <div className="rating">
                                    {reviewStats.Location == -1
                                        ? "?"
                                        : reviewStats.Location}
                                </div>
                                <h2>Location</h2>
                            </div>
                            <div className="rating-block">
